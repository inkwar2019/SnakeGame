...
def check_collision():
    global FOOD,BODY,FOOD_NUM,IN_GAME,PAUSE,BACKUP_DIR,DIR,GAMEOVER,score
...
def gaming():
    global BODY,board,CURRENT_THEME,score,last_score,PAUSE,DIR,DOT_SIZE,FOOD_NUM,FOOD,GAMEOVER,HEART,COUNTER
...
def game_initialize():
    global BODY,score,DIR,PAUSE,LENGTH,FOOD_NUM,FOOD,COUNTER
    score = 0
    BODY = []
    FOOD = []
    ENEMY = []
